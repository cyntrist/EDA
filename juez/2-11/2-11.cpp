/*
Nombre completo: Cynthia Tristán Álvarez
Usuario del juez: EDA-GDV73
Puesto de laboratorio: 0216
*/
...
// O(log n) donde n es la cantidad de elementos del vector sec
// esto es porque es una busqueda binaria
